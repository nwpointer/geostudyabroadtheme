...
- default  => define default classes, browser resets and admin styles (compiles to css/default.css)
- ie8      => used to debug IE8 (compiles to css/ie8.css)
- ie9      => used to debug IE9 (compiles to css/ie9.css)
- layout   => define the layout of the theme (compiles to css/layout.css)
- print    => define the way the theme look like when printed (compiles to css/print.css)
- style    => contains some default font styles. that's where you can add custom css (compiles to css/style.css)
- tabs     => styles for the admin tabs (from ZEN)
