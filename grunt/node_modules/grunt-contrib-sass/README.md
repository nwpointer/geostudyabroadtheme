...
Note: Files that begin with "_" are ignored even if they match the globbing pattern. This is done to match the expected [Sass partial behaviour](http://sass-lang.com/documentation/file_REFERENCE.html#partials).
...
Instead of concatenating the files, just `@import` them into another `` file eg. `main.scss`.
